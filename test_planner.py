...
# Remember to use the dot syntax of "planner.functionName()" when referencing functions from the other file.

#print(planner.perfect_day('sunny'))

#print(planner.perfect_day('rainy'))

#print(planner.outdoor_fun('windy'))

print(planner.temp_check('sunny',60))
